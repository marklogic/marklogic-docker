...
pipeline {
    ...
    parameters {
        ...
        choice(name: 'platformString', defaultValue: 'centos\nubi\nubi-rootless', description: 'Platform type for Docker image. Will be made part of the docker image tag', trim: true)
