...
#***************************************************************************
docker-tests: 
	cd test; robot -x docker-tests.xml --outputdir test_results --variable TEST_IMAGE:${test_image} --variable MARKLOGIC_VERSION:${version} --variable BUILD_BRANCH:${build-branch} ./docker-tests.robot
