...
```
3. Now, run a MarkLogic Docker container using the latest release of the Docker image. Use the same volume, mounted to the container that was running the older release. Container name should change to avoid conflicts with the older container.
```
$ docker run -d -it -p 8000:8000 -p 8001:8001 -p 8002:8002 \
